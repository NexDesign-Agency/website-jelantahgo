...
export default function CaraJualMinyakJelantahPage() {
  ...
  const howToSteps = [
    {
      name: 'Hubungi Kami',
      text: 'Hubungi JelantahGo via WhatsApp +62 812-2082-1983, telepon, atau email. Siapkan informasi: estimasi volume, lokasi, jenis minyak, dan jadwal yang diinginkan. Response time: 5-30 menit di jam kerja.',
          ...
          <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="card-premium">
              ...
              <p className="text-center mt-4 text-gray-700">
                Untuk harga update terbaru, <a href="https://wa.me/6281220821983" target="_blank" rel="noopener noreferrer" className="text-[#0F3D2E] font-semibold hover:underline">hubungi WhatsApp kami →</a>
              </p>
            </div>
          </div>
        </div>
