...
export const metadata: Metadata = {
  title: 'Bisnis Pengepul Jelantah 2025: Modal, Untung & Pemasaran | JelantahGO',
  ...
  twitter: {
    ...
    description: 'Ingin jadi pengepul minyak jelantah? Panduan bisnis A-Z ini membahas rincian modal, simulasi keuntungan puluhan juta.',
