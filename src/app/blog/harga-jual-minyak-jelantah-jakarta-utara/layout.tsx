...
export const metadata: Metadata = {
  title: 'Harga Jual Minyak Jelantah Terbaik di Jakarta Utara 2025: Update & Tips | JelantahGO',
  ...
  twitter: {
    ...
    title: 'Harga Jual Minyak Jelantah Terbaik di Jakarta Utara 2025: Update & Tips',
