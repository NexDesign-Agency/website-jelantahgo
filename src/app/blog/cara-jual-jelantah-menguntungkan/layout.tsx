...
export const metadata: Metadata = {
  title: 'Cara Jual Minyak Jelantah yang Paling Menguntungkan: 5 Strategi Terbukti | JelantahGO',
  ...
  twitter: {
    ...
    description: 'Pelajari 5 strategi jual minyak jelantah yang paling menguntungkan. Tips memilih pengepul, negosiasi harga, dan cara dapat harga terbaik.',
