...
Alamat: ${formData.address}`
    window.open(`https://wa.me/6281220821983?text=${encodeURIComponent(message)}`, '_blank')
  }
                ...
                <section id="langkah-1" className="mb-12">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="card-premium">
                      ...
                      <ol className="space-y-2 text-gray-700 mb-4">
                        <li>1. Hubungi: <a href="tel:+6281220821983" className="text-[#0F3D2E] font-semibold hover:underline">0812-2082-1983</a></li>
                  ...
                  <div className="bg-gradient-to-br from-[#0F3D2E] to-[#134E3A] rounded-card-lg p-8 text-white">
                    ...
                    <div className="text-center mb-6">
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                          href="https://wa.me/6281220821983?text=Halo%20JelantahGO,%20 saya%20ingin%20jual%20minyak%20jelantah"
                          target="_blank"
                          rel="noopener"
