...
export const metadata: Metadata = {
  title: '5 Skrip & Template Penawaran Kerjasama Jelantah untuk Akuisisi Pemasok | JelantahGO',
  ...
  twitter: {
    ...
    title: '5 Skrip & Template Penawaran Kerjasama Jelantah untuk Akuisisi Pemasok',
