...
export const metadata: Metadata = {
  title: 'Pengepul Jelantah Terpercaya di Jakarta Selatan: Solusi Cepat untuk Kafe & Resto | JelantahGO',
  ...
  twitter: {
    ...
    title: 'Pengepul Jelantah Terpercaya di Jakarta Selatan: Solusi Cepat untuk Kafe & Resto',
