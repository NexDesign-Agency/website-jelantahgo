...
export const metadata: Metadata = {
  title: 'Kisah Sukses Pengepul Jelantah Pak Doni: Dari Karyawan Pabrik ke Omzet 20 Juta/Bulan | JelantahGO',
  ...
  twitter: {
    ...
    title: 'Kisah Sukses Pengepul Jelantah Pak Doni: Dari Karyawan Pabrik ke Omzet 20 Juta/Bulan',
