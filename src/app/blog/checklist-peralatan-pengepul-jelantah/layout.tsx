...
export const metadata: Metadata = {
  title: 'Checklist Peralatan Pengepul Jelantah Lengkap: Dari Timbangan hingga Armada | JelantahGO',
  ...
  twitter: {
    ...
    title: 'Checklist Peralatan Pengepul Jelantah Lengkap: Dari Timbangan hingga Armada',
