...
export const metadata: Metadata = {
  title: 'Kisah Sukses Ibu Rina: Dari Dapur Rumah ke Mitra Pengepul dengan Omzet Jutaan | JelantahGO',
  ...
  twitter: {
    ...
    title: 'Kisah Sukses Ibu Rina: Dari Dapur Rumah ke Mitra Pengepul dengan Omzet Jutaan',
