...
export const metadata: Metadata = {
  title: '5 Langkah Negosiasi Harga Pengepul Jelantah untuk Dapat Harga Terbaik | JelantahGO',
  ...
  twitter: {
    ...
    title: '5 Langkah Negosiasi Harga Pengepul Jelantah untuk Dapat Harga Terbaik',
