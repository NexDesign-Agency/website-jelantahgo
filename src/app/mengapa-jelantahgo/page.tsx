          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a
                  href="https://wa.me/6281220821983?text=Halo%20JelantahGO,%20saya%20ingin%20kontribusi%20untuk%20lingkungan"
                  target="_blank"
        ...
        <div className="container-custom">
          <div className="space-y-16 max-w-5xl mx-auto">
            ...
            <div className="card-premium">
              ...
              <div className="mt-6 text-center">
                <a
                  href="https://wa.me/6281220821983?text=Halo%20JelantahGo,%20saya%20ingin%20jadwalkan%20pickup"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-[#0F3D2E] text-white px-6 py-3 rounded-card font-bold hover:bg-[#134E3A] transition-all"
                >
        ...
        <div className="container-custom text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
              <a
                href="https://wa.me/6281220821983?text=Halo%20JelantahGo,%20saya%20ingin%20mulai%20jual%20jelantah"
                target="_blank"
                rel="noopener noreferrer"
      ...
      <section className="py-16 bg-white">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <a
              href="https://wa.me/6281220821983?text=Halo%20JelantahGo,%20saya%20ingin%20mulai%20sekarang"
              target="_blank"
              rel="noopener noreferrer"
