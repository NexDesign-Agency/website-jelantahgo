    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Pengepul Minyak Jelantah Jakarta Timur',
      },
    ],
    locale: 'id_ID',
    type: 'website',
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-8">
                <a
                  href="https://wa.me/6281220821983?text=Halo%20JelantahGO,%20saya%20ingin%20dijemput%20hari%20ini%20di%20Jakarta%20Timur"
                  target="_blank"
        ...
        <div className="container-custom text-center relative z-10">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <a
                href="https://wa.me/6281220821983?text=Halo%20JelantahGO,%20saya%20ingin%20mulai%20jual%20jelantah%20di%20Jakarta%20Timur"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white text-[#0F3D2E] hover:bg-[#F9F8F6] px-8 py-4 rounded-card font-bold text-lg flex items-center justify-center gap-2 transition-smooth shadow-soft-lg hover:shadow-soft-xl"
              >
